...
class SuggestionsAdapter1(
    private val list: List<SuggestPair>,
    context: Context,
    private val viewModel: MainViewModel
) : RecyclerView.Adapter<SuggestionsAdapter1.SuggestViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SuggestionsAdapter1.SuggestViewHolder {
    ...
    override fun onBindViewHolder(holder: SuggestionsAdapter1.SuggestViewHolder, position: Int) {
