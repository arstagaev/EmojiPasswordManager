...
class SuggestionsAdapter2(
...
) : RecyclerView.Adapter<SuggestionsAdapter2.SuggestViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SuggestionsAdapter2.SuggestViewHolder {
    ...
    override fun onBindViewHolder(holder: SuggestionsAdapter2.SuggestViewHolder, position: Int) {
